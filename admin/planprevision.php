...
if ($_POST["Agregar"]){
	$insertar="INSERT INTO planprevision (plan ,descuento,act) 
...
if ($_POST["Modificar"]){
	$editar="update  planprevision set plan  = '$_POST[nombre_plan2]',descuento = '$_POST[descuento2]' where id_plan = '$_GET[id]' ";
	$sentencia = mysql_query($editar,$conn)or die("Error al grabar la venta: ".mysql_error);
}
if ($_GET["fun"]=="eli"){
	$editar="update  planprevision set act  = 'no' where id_plan = '$_GET[id]' ";
	$sentencia = mysql_query($editar,$conn)or die("Error al grabar la venta: ".mysql_error);
}
?>
...
<div align="center">
  <p><span class="Titulo">Planes de Prevision</span></p>
  <p><table width="100" border="0" cellpadding="0" cellspacing="0" bgcolor="#FF9900">
    <tr>
      <td height="15" align="center" valign="middle"><div align="center"><a href="planprevision.php?fun=new" class="Letra1_blanca">NUEVO PLAN</a></div></td>
    </tr>
  </table></p>
  </div>
<?php if ($_GET["fun"]=="new"){ ?>
<form action="planprevision.php" method="post" name="form1" id="form1" onsubmit="MM_validateForm('nombre','','R','descripcion','','R');return document.MM_returnValue">
...
<?php if ($_GET["fun"]=="edi"){ 
    $listado = "select * from planprevision where id_plan ='$_GET[id]' ";
	$sentencia = mysql_query($listado,$conn);
	if($rs=mysql_fetch_array($sentencia,$mibase)){
?>
<form action="planprevision.php?id=<?php echo $_GET["id"]; ?>" method="post" name="form1" id="form1" onsubmit="MM_validateForm('nombre2','','R','descripcion2','','R');return document.MM_returnValue">
  <table width="80%"  border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td width="50%" align="left" class="Contenidonegro"><div align="right">Nombre del plan</div></td>
      <td width="50%"><div align="left">
...
<table width="80%" border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  ?>
  <tr>
    <td><div align="center"><a href="planprevision.php?fun=edi&amp;id=<?php echo $rs["id_plan"]; ?>"><img src="Lapiz.png" width="16" height="16" border="0" /></a></div></td>
    <td><div align="center"><a href="planprevision.php?fun=eli&amp;id=<?php echo $rs["id_plan"]; ?>" onClick=" return confirm('¿Está Seguro que desea eliminar?');"><img src="b_drop.png" alt="Eliminar cargo" width="16" height="16" border="0" /></a></div></td>
