...
if ($_GET["fun"]=="eli"){
	$editar="update  capacitaciones_trabajador set act  = 'no' where empresa = '$_SESSION[$nusuario]' and trabajador ='$_GET[rut]' ";
...
<table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="289" align="center"><span class="Titulo">Capacitaciones del trabajador</span></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <?php 
    $listado = "select * from capacitaciones_trabajador where act ='si' and trabajador = '$_GET[rut]'";
	$sentencia = mysql_query($listado,$conn);
	while($rs=mysql_fetch_array($sentencia,$mibase)){
  ?>
  <tr>
