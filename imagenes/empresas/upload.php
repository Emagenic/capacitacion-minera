...
if (!((strpos($tipo_archivo, "jpg") || strpos($tipo_archivo, "png")) && ($tamano_archivo < 100000))) { 
    ...
    if (move_uploaded_file($HTTP_POST_FILES['userfile']['tmp_name'], $nombre_archivo)){ 
		...
		echo "<div align=center><span class=Titulo><a href=../../admin/detalleempresaeditar.php class=Titulo>Volver</a></span></div>";
	}else{ 
